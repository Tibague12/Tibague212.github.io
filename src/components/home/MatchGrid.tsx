...
const MOCK_MATCHES: Match[] = [
  ...
  {
    id: '2',
    title: 'European Handball Finals',
    sport: 'Handball',
  ...
  {
    id: '6',
    title: 'Nations League Volleyball',
    sport: 'Volleyball',
    date: 'Sat 4 Apr 2026',
    time: '17:00 GMT',
      ...
      <div className="container mx-auto px-4 lg:px-8 space-y-8">
          ...
          <div className="space-y-2">
            <h2 className="text-3xl font-bold font-heading tracking-tight flex items-center gap-3">
              ...
              <Badge variant="secondary" className="px-3 rounded-full bg-primary/10 text-primary border-primary/20">
                {filteredMatches.length} events found
              </Badge>
            </h2>
            <p className="text-muted-foreground font-medium">Find tickets for your favorite sports teams.</p>
          </div>
        ...
        {filteredMatches.length > 0 ? (
          ...
          <div className="py-24 text-center space-y-4">
            ...
            <h3 className="text-xl font-bold font-heading">No matches found</h3>
            <p className="text-muted-foreground max-w-xs mx-auto">Try adjusting your search query or sport filters.</p>
